...
const CHROMEWEBDRIVER = process.env.CHROMEWEBDRIVER ? (process.env.CHROMEWEBDRIVER + '/chromedriver') : '';
const GECKOWEBDRIVER = process.env.GECKOWEBDRIVER ? (process.env.GECKOWEBDRIVER + '/geckodriver') : '';
const EDGEWEBDRIVER = process.env.EDGEWEBDRIVER ? (process.env.EDGEWEBDRIVER + '/msedgedriver') : '';
const SAFARIWEBDRIVER = process.env.SAFARIWEBDRIVER ? (process.env.SAFARIWEBDRIVER + '/safaridriver') : '';
